...
def position_continuity_two_splines(obj_size, is_positive, clu_num, params, obj_quantity):
    objs = []
...
def non_overlap_two_splines(params, is_positive, clu_num, obj_quantity):
    obj_size = 0.05
    objs = position_continuity_two_splines(obj_size, is_positive, clu_num, params, obj_quantity)
    t = 0
    tt = 0
    max_try = 1000
