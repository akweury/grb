...
def analysis(principle):
    ...
    pdf_filename = f"{principle}_vit_model_performance_charts.pdf"
    plt.tight_layout()
    ...
    tools.display_dataframe_to_user(name="Formatted Performance Table", dataframe=formatted_performance_table)
